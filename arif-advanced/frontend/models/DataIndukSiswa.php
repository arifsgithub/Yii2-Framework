...
class DataIndukSiswa extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['nama', 'alamat', 'tempat_lahir', 'nama_ortu'], 'string', 'max' => 50],
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getSiswaKelasTahunAjaran()
    {
        return $this->hasMany(SiswaKelasTahunAjaran::className(), ['id_data_induk_siswa' => 'id']);
    }
}
