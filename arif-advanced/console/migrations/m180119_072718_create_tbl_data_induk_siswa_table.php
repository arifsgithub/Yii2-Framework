 ...
 * - `user`
 */
class m180119_072718_create_tbl_data_induk_siswa_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('tbl_data_induk_siswa', [
            ...
            'alamat' => $this->string(50)->notNull(),
            'tempat_lahir' => $this->string(50)->notNull(),
            'tanggal_lahir' => $this->date()->notNull(),
            'nama_ortu' => $this->string(50)->notNull(),
